...
urlpatterns = [
    ...
    path('malware/skills/', views.malware_skills, name='malware_skills'),
    path('ptgui_viz/', views.ptguihome, name='ptgui_viz_main'),
    path('pt-gui-skills/', views.ptgui_skills, name='ptgui_skills'),
    ...
    path('smishing-skills/', views.smishing_skills, name='smishing_skills'),
    ...
    path('cybersafe-vr-skills/', views.cybersafe_vr_skills, name='cybersafe_vr_skills'),
